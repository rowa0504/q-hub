        ...
        <table class="table table-hover align-middle text-secondary">
            ...
            <tbody>
                ...
                @php
                    ...
                    $reportedUser = $reportable instanceof App\Models\User
                        ? $reportable
                        : ($reportable?->user ?? null);
                ...
                <tr>
                    ...
                    <td>
                        @if ($report->status == 'pending')
                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#warnModal-{{ $report->id }}">
