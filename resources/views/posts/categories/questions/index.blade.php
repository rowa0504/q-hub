    ...
    @php
        ...
        $questions = [
            (object) [
                ...
                'body' =>
                    'I am new to Laravel. Can someone walk me through the installation steps on Windows? lorem300 ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
                'comments_count' => 2,
            ...
            (object) [
                ...
                'body' =>
                    'I keep hearing about MVC. Can someone explain how it works in Laravel?lorem10000 ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
                'comments_count' => 5,
                        ...
                        <div class="card-body d-flex">
                            <div class="me-3">
                                <div class="rounded-circle"
                                    style="width: 40px; height: 40px; background-color: {{ $question->user->icon }}"></div>
                            </div>
