<div class="d-flex justify-content-between align-items-start border-bottom py-2 w-100">
    {{-- ユーザーアバター --}}
    <a href="{{ route('profile.index', $comment->user->id ?? '#') }}" class="text-decoration-none avatar-sm me-1">
