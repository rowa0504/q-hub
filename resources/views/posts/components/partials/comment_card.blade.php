            ...
            @if (Auth::id() === $comment->user_id)
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button class="dropdown-item text-warning" onclick="editComment({{ $comment->id }})"><i
                                    class="fa-solid fa-pen-to-square"></i> Edit</button>
                        </li>
                        <li>
                            <button class="dropdown-item text-danger" onclick="deleteComment({{ $comment->id }})"><i
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item text-danger" data-bs-toggle="modal"
                            data-bs-target="#reportCommentModal-${data.id}">
